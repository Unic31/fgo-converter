export const i18n = {
	KR: {
		translation: 'AI를 사용하여 번역되었으며 어색하거나 부자연스러운 표현이 있을 수 있습니다.',
		desc: '칼데아앱(Chaldea)의 공유 URL을 폰닉(FGA)용 커맨드로 변환합니다.',
		howtouse: '사용방법',
		loading1: '아틀라스원과 통신 중...',
		loading2: '변환하기',
		error1: '⚠️ 올바른 링크인지 확인해주세요.',
		commandText: '변환된 커맨드',
		...
		btnOk: '확인',
		converterGuide: {
			guide1: "1. URL 가져오기(A, B 중 택 1)",
			g1: 'A. 이미 등록된 전투 시뮬레이터 가져오기',
			g2: '꼭!! 두번째 링크 클릭해서 URL 복사',
			g3: 'B. 직접 테스트한 전투 시뮬레이터 등록하고 가져오기',
			g4: '서버가 아닌 기기에 해당 팀에 등록하고 가져오는 방법입니다.',
			guide2: "2. URL 복사하고 붙여넣기",
		},
		copy: '복사',
	...
	JP: {
		translation: 'AIによる翻訳のため、一部不自然な表現が含まれる場合がございます。',
		desc: 'カルデアアプリ(Chaldea)の共有URLをFGA用コマンドに変換します。',
		howtouse: '使い方',
		loading1: 'アトラス院と通信中...',
		loading2: '変換する',
		error1: '⚠️ 正しいリンクかご確認ください。',
		...
		btnOk: '確認',
		converterGuide: {
			guide1: '1. URLの取得 (AまたはBから選択)',
			g1: 'A. すでに登録されている戦闘シミュレーターを取得',
			g2: '※必ず2番目のリンクをクリックしてURLをコピーしてください',
			g3: 'B. 自らテストした戦闘シミュレーターを登録して取得',
			g4: 'サーバーではなく、端末上の該当チームに登録して取得する方法です。',
			guide2: '2. URLをコピー＆ペースト',
		},
		copy: 'コピー',
	...
	EN: {
		translation: 'This translation was generated by AI and may contain awkward or unnatural phrasing.',
		desc: 'Converts the shared URL of Chaldea to a command for FGA.',
		howtouse: 'How to use',
		loading1: 'Communicating with Atlas Academy...',
		loading2: 'Convert',
		error1: '⚠️ Please check if the link is valid.',
		...
		btnOk: 'OK',
		converterGuide: {
			guide1: '1. Get URL (Select A or B)',
			g1: 'A. Retrieve an already registered combat simulator',
			g2: 'Make sure to click the second link to copy the URL!',
			g3: 'B. Register and retrieve a custom combat simulator you tested',
			g4: 'This method registers the team on your device locally rather than on the server.',
			guide2: '2. Copy and Paste the URL',
		},
		copy: 'Copy',
		...
		listOption3a: 'All',
		listOption3b: 'Owned',
		listOption3c: 'Unowned',
		listOption4: 'Size',
		listOption5: 'L Click',
		listOption5a: 'Category',
		listOption5b: 'Palingenesis',
		listOption5c: 'Grand',
		listOption6: 'R Click',
		listOption6a: 'Decrease',
		listOption6b: 'Palingenesis',
		listOption6c: 'Grand',
		listOption7: 'NP Cap',
		listOption7a: 'Lv. 5',
		listOption7b: 'No Limit'
	}
};